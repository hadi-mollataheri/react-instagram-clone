...
const Home = () => {
  ...
  return (
    <div className='parent-container'>
      <div className='nav-main-suggestion-container mt-5 sm:grid sm:grid-cols-3 sm:grid-rows-1'>
      ...
      <footer className='w-full self-center'>
        <p className='mb-2 w-full text-center text-sm'>
          &copy; 2025 built by Hadi mTaheri
        </p>
      </footer>
